...
/**
 * JwtService es un servicio encargado de generar y validar tokens JWT (JSON Web
 * Tokens) utilizados para la autenticación.
 * Permite la generación de tokens con reclamaciones personalizadas y la
...
public class JwtService {
    ...
    /**
     * Genera un token JWT con las reclamaciones proporcionadas y la información del
     * usuario.
     *
