...
import cl.nisum.services.JwtService;

import java.io.IOException;

/**
 * Filtro de autenticación JWT que intercepta las solicitudes entrantes y
 * verifica la presencia de un token JWT válido en la cabecera de autorización.
 * Si se encuentra un token válido, autentica al usuario y establece la
